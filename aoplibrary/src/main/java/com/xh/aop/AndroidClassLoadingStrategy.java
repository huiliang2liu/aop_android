 ...
 * application. For this, a {@link DexClassLoader} is used under the covers.
 * </p>
 * <p>
 ...
 * implementing the methods of a  to
...
public abstract class AndroidClassLoadingStrategy implements ClassLoadingStrategy<ClassLoader> {
    ...
    /**
     * The name of the dex file that the {@link DexClassLoader} expects to find inside of a jar file
    ...
    /**
     * A value for a {@link DexClassLoader} to indicate that the library path is empty.
     */
